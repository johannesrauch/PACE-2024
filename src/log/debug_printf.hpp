...
void printf_info(const branch_and_cut_info& info_br, const highs_lp_info& info_lp) {
    if (info_br.n_iterations % 50 == 0) {
        fmt::printf("%11s%11s%11s|%11s%11s%11s%11s%11s%11s%11s|%11s%11s%11s%11s|%11s%11s%11s%11s%11s|%11s\n",  //
                    "walltime", "lb", "ub",                                                                    //
                    "iter", "obj val", "t simplex", "n simplex", "n splx avg", "n rows", "n nodes",            //
                    "n bucket", "n added", "n delete", "n spared",                                             //
                    "uvw iter", "on node", "u", "v", "w",                                                      //
                    "rh conf");
    }
    fmt::printf("%11.1f%11u%11u|%11u%11.1f%11.1f%11u%11.1f%11u%11u|%11u%11u%11u%11u|%11u%11u%11u%11u%11u|%11.3f\n",  //
                elapsed_walltime_in_s(), info_br.lower_bound, info_br.upper_bound,                                   //
                info_br.n_iterations, info_lp.objective_value, info_lp.t_simplex, info_lp.n_iterations_simplex,
                info_lp.n_iterations_simplex_avg, info_lp.n_rows,
