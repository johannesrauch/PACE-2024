...
void printf_info(const branch_and_cut_info& info_br, const highs_lp_info& info_lp) {
    ...
    fmt::printf(  //
        ...
        info_br.n_iters, info_lp.objective_value, info_lp.t_simplex, info_lp.n_rows, info_br.n_branch_nodes,
        info_br.depth,  //
        info_lp.n_simplex_iters, info_lp.n_avg_simplex_iters, info_lp.n_simplex_coldstart_iters,
        info_lp.was_warmstart,  //
        info_lp.n_bucket_entries, info_lp.n_added_rows, info_lp.n_deleted_rows,
        info_lp.n_delete_rows_spared,  //
        info_lp.n_3cycle_iters, info_br.n_iter_3cycle_current_node, info_lp.u_old, info_lp.v_old,
        info_lp.w_old,  //
...
inline void printf_lpinfo(const highs_lp_info& info) {
    fmt::printf("%11.1f|%11u%11.1f%11u%11u%11.1f|%11u%11u%11u%11u|%11u%11u%11u%11u\n",  //
                ...
                info.n_solve_iters, info.objective_value, info.n_rows, info.n_simplex_iters,
                info.n_avg_simplex_iters,  //
                info.n_bucket_entries, info.n_added_rows, info.n_deleted_rows,
                info.n_delete_rows_spared,  //
                info.n_3cycle_iters, info.u_old, info.v_old, info.w_old);
    std::cout << std::flush;
}
